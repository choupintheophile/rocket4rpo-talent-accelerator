...
export default function RecrutementTechStartupPageClient() {
  const schemas = [
  ...
  return (
    <>
      ...
      <Breadcrumbs items={[{ label: "Accueil", href: "/" }, { label: "Recrutement Tech Startup" }]} />
      ...
      <section className="section-padding pt-8">
        <div className="container-wide">
          <div className="max-w-4xl">
            <motion.div {...fadeUp}>
              <span className="inline-block px-3 py-1 text-xs font-semibold tracking-wider uppercase rounded-full bg-primary/10 text-primary mb-4">Recrutement Tech</span>
        ...
        <div className="container-wide">
          <div className="max-w-3xl mx-auto">
            <motion.div {...fadeUp}>
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed text-lg">
                <p>
                  Les startups ont besoin de rapidité, d&apos;agilité et de compréhension de leur réalité. Nos recruteurs sont eux-mêmes issus de l&apos;écosystème tech : ils parlent le même langage que vos équipes, comprennent les stacks techniques et savent évaluer le potentiel d&apos;un candidat au-delà de son CV.
                </p>
                <p>
