...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Oui, en général. Un cabinet classique facture 15-25 % du salaire annuel brut, soit 120 000 à 200 000 € pour 10 recrutements. Le RPO est jusqu'à 5x moins cher, sur un modèle prévisible et transparent. Plus le volume est élevé, plus l'écart se creuse en faveur du RPO. Tarif précis sur devis.",
  },
  {
        ...
        <div className="container-tight">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            >
              ...
              <p className="text-sm text-muted-foreground mt-1">Jusqu'à -75% vs cabinet</p>
