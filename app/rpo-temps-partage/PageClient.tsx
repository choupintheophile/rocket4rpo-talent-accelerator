...
export default function RPOTempsPartagePageClient() {
  const schemas = [
  ...
  return (
    <>
      ...
      <Breadcrumbs items={[{ label: "Accueil", href: "/" }, { label: "RPO à temps partagé" }]} />
          ...
          <div className="max-w-4xl">
            <motion.div {...fadeUp}>
              ...
              <p className="mt-6 text-lg md:text-xl text-muted-foreground leading-relaxed max-w-3xl">
                Intégrez un recruteur RPO expérimenté quelques jours par semaine dans vos équipes. Flexibilité maximale, expertise immédiate,
          ...
          <div className="max-w-3xl mx-auto">
            <motion.div {...fadeUp}>
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed text-lg">
                <p>
                  Le RPO (Recruitment Process Outsourcing) à temps partagé consiste à externaliser tout ou partie de votre processus de recrutement
                  auprès d&apos;un expert dédié, sans avoir à supporter le coût d&apos;un recruteur interne à temps plein. Concrètement, un Talent
                  Acquisition Specialist expérimenté s&apos;intègre dans vos équipes quelques jours par semaine — de 1 à 4 jours selon vos besoins —
                  pour piloter vos recrutements de bout en bout.
                </p>
                <p>
                  Ce modèle est particulièrement adapté aux entreprises en croissance qui ont des besoins de recrutement réguliers mais pas
                  suffisamment volumiques pour justifier un poste dédié. Il permet d&apos;accéder à une expertise senior immédiatement opérationnelle :
                  sourcing avancé, qualification structurée, coordination avec les hiring managers, pilotage des indicateurs de performance recrutement.
                </p>
                <p>
                  Contrairement au recrutement au succès ou au cabinet classique, le RPO à temps partagé crée une relation de proximité avec vos
                  équipes. Le recruteur comprend votre culture, vos enjeux métiers et vos processus internes, ce qui se traduit par des shortlists plus
                  pertinentes et un time-to-hire significativement réduit.
                </p>
              </div>
            </motion.div>
          </div>
        ...
        <div className="container-wide">
          <div className="max-w-3xl mx-auto">
            <motion.div {...fadeUp}>
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed text-lg">
                <p>
                  Ce modèle convient aux startups et scale-ups qui recrutent entre 3 et 15 postes par trimestre, aux PME en structuration qui n&apos;ont
                  pas encore de fonction recrutement dédiée, et aux entreprises en transformation qui ont besoin d&apos;accélérer ponctuellement leurs
                  recrutements sans créer de poste supplémentaire.
                </p>
                <p>
                  Il est également pertinent pour les entreprises disposant d&apos;un recruteur interne qui a besoin de renfort : le RPO à temps
                  partagé vient compléter la capacité existante avec une expertise complémentaire, notamment sur le sourcing de profils pénuriques ou
