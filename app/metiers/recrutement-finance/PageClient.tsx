...
const faqs = [
  { question: "Quels profils Finance recrutez-vous ?", answer: "Nous recrutons l'ensemble des profils Finance : CFO / DAF, VP Finance, Head of Finance, FP&A Analyst / Manager, Contrôleur de gestion, Comptable, Trésorier, Revenue Operations Finance et Office Manager Finance." },
  { question: "Recrutez-vous des profils Finance pour des startups ?", answer: "Oui. Nous comprenons les enjeux spécifiques des startups et scale-ups en matière de structuration financière : levées de fonds, modélisation financière, mise en place des process financiers et pilotage de la trésorerie." },
  { question: "Comment évaluez-vous un profil Finance ?", answer: "Nous évaluons la rigueur, la fiabilité, la compréhension des enjeux financiers et la capacité à structurer la fonction Finance dans un environnement en croissance." },
  { question: "Comprenez-vous les spécificités financières des entreprises en croissance ?", answer: "Absolument. Nos recruteurs spécialisés comprennent les modèles financiers, les enjeux de pilotage budgétaire, de trésorerie et de reporting investisseurs." },
  ...
  { question: "Recrutez-vous des profils FP&A ?", answer: "Oui. Le FP&A est un rôle clé en entreprise. Nous évaluons la capacité à construire des modèles financiers, piloter le budget, produire des analyses décisionnelles et collaborer avec les équipes opérationnelles." },
  { question: "Quelle est la différence avec un cabinet de recrutement Finance classique ?", answer: "Un cabinet classique évalue un profil Finance sur son parcours et ses certifications. Nous évaluons sa capacité à structurer, piloter et contribuer à la croissance dans un environnement exigeant." },
