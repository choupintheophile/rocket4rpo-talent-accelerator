...
export default function RecrutementSalesPageClient() {
  const schemas = [
      serviceSchema("Recrutement de profils commerciaux Tech et SaaS", "Recrutez vos profils commerciaux Tech et SaaS avec Rocket4RPO. Plus de 7 ans d'expertise terrain dans le recrutement sales.", "/metiers/recrutement-sales"),
      faqSchema(faqs),
      breadcrumbSchema([
        { name: "Accueil", url: "/" },
...
<Breadcrumbs items={[{ label: "Métiers", href: "/metiers/recrutement-sales" }, { label: "Recrutement Sales" }]} />
