...
export const metadata: Metadata = {
  ...
  description:
    "RPO, CDD ou CDI : le top 1% des Talent Acquisition de France intégré à vos équipes en 1 semaine. Dès 500€/j. 200+ recrutements. Diagnostic gratuit →",
...
export default function Page() {
  const schemas = [
    ...
    faqSchema([
      ...
      { question: "Combien ça coûte ?", answer: "À partir de 500€/jour. Pour 10 recrutements sur 4 mois, comptez environ 30 000€ — soit jusqu'à 5x moins cher qu'un cabinet classique (120 000 à 200 000€)." },
      { question: "Combien de temps pour être opérationnel ?", answer: "1 semaine. Le TA Specialist rejoint vos outils (ATS, Slack, Teams) et vos rituels dès le premier jour. Première shortlist qualifiée en 5-7 jours." },
