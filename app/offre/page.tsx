...
export default function Page() {
  const schemas = [
    ...
    faqSchema([
      ...
      { question: "Combien ça coûte ?", answer: "Tarification sur devis, adaptée à votre volume et à la nature des postes. Jusqu'à 5x moins cher qu'un cabinet classique (120 000 à 200 000€ pour 10 recrutements). Réservez un diagnostic gratuit pour un chiffrage précis." },
