...
export default function Page() {
  const schemas = [
    ...
    faqSchema([
      ...
      { question: "Combien de temps pour être opérationnel ?", answer: "1 semaine. Le TA Specialist rejoint vos outils (ATS, Slack, Teams) et vos rituels dès le premier jour. Première shortlist qualifiée en 48h." },
