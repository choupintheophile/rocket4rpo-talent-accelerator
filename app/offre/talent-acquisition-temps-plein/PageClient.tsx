...
export default function TalentAcquisitionTempsPleinPageClient() {
  const schemas = [
      serviceSchema("Talent Acquisition à temps plein", "Un Talent Acquisition Specialist senior intégré à 100 % dans vos équipes pour piloter vos recrutements avec exigence, rapidité et méthode.", "/offre/talent-acquisition-temps-plein"),
      faqSchema(faqs),
      breadcrumbSchema([
...
<Breadcrumbs
      items={[
        { label: "Offres", href: "/offre/talent-acquisition-temps-plein" },
      ...
      <div className="container-wide">
        ...
        <motion.div {...fadeUp} className="mt-8 text-center">
          <p className="text-muted-foreground">
            ...
            <Link href="/offre/recrutement-talent-acquisition"
        ...
        <motion.div {...fadeUp} className="mt-16 pt-12 border-t border-border">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {[
              ...
              { label: "Recrutement de Recruteurs", href: "/offre/recrutement-talent-acquisition" },
