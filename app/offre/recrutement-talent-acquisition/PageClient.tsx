...
export default function RecrutementTalentAcquisitionPageClient() {
  const schemas = [
      serviceSchema("Recrutement de Talent Acquisition", "Recrutement de Talent Acquisition Specialists et Managers basé sur la performance réelle. Sélection exigeante, expertise métier, vivier qualifié.", "/offre/recrutement-talent-acquisition"),
      faqSchema(faqs),
      breadcrumbSchema([
...
<Breadcrumbs
      items={[
        { label: "Offres", href: "/offre/recrutement-talent-acquisition" },
