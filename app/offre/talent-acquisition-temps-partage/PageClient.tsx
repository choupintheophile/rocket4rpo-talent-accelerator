...
export default function TalentAcquisitionTempsPartagePageClient() {
  const schemas = [
...
<Breadcrumbs items={[{ label: "Offres", href: "/offre/talent-acquisition-temps-partage" }, { label: "Talent Acquisition à temps partagé" }]} />
      ...
      <div className="container-wide">
        ...
        <motion.div {...fadeUp} className="mt-8 text-center">
          <p className="text-muted-foreground">
            ...
            <Link href="/offre/recrutement-talent-acquisition" className="text-primary font-medium hover:underline">
