  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        rocket: {
          dark: "hsl(var(--rocket-dark))",
          "dark-soft": "hsl(var(--rocket-dark-soft))",
          teal: "hsl(var(--rocket-teal))",
          "teal-light": "hsl(var(--rocket-teal-light))",
          "teal-glow": "hsl(var(--rocket-teal-glow))",
