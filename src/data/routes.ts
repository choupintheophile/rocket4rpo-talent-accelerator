...
export const sitemapRoutes: SitemapRoute[] = [
  ...
  { path: "/rpo-temps-partage", label: "RPO à temps partagé", category: "Offre", priority: 0.9 },
  { path: "/rpo-temps-plein", label: "RPO à temps plein", category: "Offre", priority: 0.9 },
  { path: "/recrutement-tech-startup", label: "Recrutement Tech Startup", category: "Offre", priority: 0.8 },
  { path: "/mentions-legales", label: "Mentions légales", category: "Légal", priority: 0.3 },
  { path: "/politique-confidentialite", label: "Politique de confidentialité", category: "Légal", priority: 0.3 },
  { path: "/cgu", label: "Conditions générales d'utilisation", category: "Légal", priority: 0.3 },
];
