...
const RecrutementMarketing = () => (
  <Layout>
    <SEO
      ...
      canonical="/metiers/recrutement-marketing"
      schema={[
    ...
    />
    <Breadcrumbs items={[{ label: "Métiers", to: "/metiers/recrutement-marketing" }, { label: "Recrutement Marketing" }]} />
