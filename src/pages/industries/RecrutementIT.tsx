...
const RecrutementIT = () => (
  <Layout>
    <SEO
      ...
      canonical="/metiers/recrutement-it"
      schema={[
        serviceSchema(
          "Recrutement de profils IT et Tech",
          "Recrutez vos profils IT et Tech avec Rocket4RPO. Talent Acquisition spécialisés IT pour des recrutements précis et performants.",
          "/metiers/recrutement-it"
        ),
        faqSchema(faqs),
        breadcrumbSchema([
          { name: "Accueil", url: "/" },
    ...
    />
    <Breadcrumbs items={[{ label: "Métiers", to: "/metiers/recrutement-it" }, { label: "Recrutement IT & Tech" }]} />
