...
const RecrutementSupport = () => (
  <Layout>
    <SEO
      ...
      canonical="/metiers/recrutement-support"
      schema={[
    ...
    />
    <Breadcrumbs items={[{ label: "Métiers", to: "/metiers/recrutement-support" }, { label: "Recrutement fonctions support" }]} />
    ...
    <section className="section-padding bg-secondary">
      <div className="container-wide">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 max-w-4xl mx-auto">
          {[
            { label: "Recrutement Sales", to: "/metiers/recrutement-sales" },
            { label: "Recrutement IT & Tech", to: "/metiers/recrutement-it" },
            { label: "Recrutement Marketing", to: "/metiers/recrutement-marketing" },
            { label: "Recrutement Finance", to: "/metiers/recrutement-finance" },
          ].map((link) => (
