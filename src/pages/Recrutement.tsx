      ...
      <div className="container-wide">
        <div className="max-w-3xl">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            <span className="inline-block px-3 py-1 text-xs font-semibold tracking-wider uppercase rounded-full bg-primary/10 text-primary mb-4">Carrières</span>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
              Vous êtes <span className="text-gradient">Talent Acquisition</span> ? Rejoignez le réseau Rocket4RPO
            </h1>
            <p className="mt-6 text-lg text-muted-foreground leading-relaxed">
              Nous recherchons en permanence des Talent Acquisition Managers et Specialists d'exception pour accompagner les entreprises Tech les plus ambitieuses.
            </p>
          </motion.div>
        </div>
      </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              {[
                ...
                { icon: Target, title: "Développement", text: "Montez en compétences sur les dernières techniques de sourcing et de recrutement." },
              ].map((item, i) => (
