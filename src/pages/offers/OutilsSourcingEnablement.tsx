...
const OutilsSourcingEnablement = () => (
  <Layout>
    <SEO
      ...
      schema={[
        serviceSchema(
          ...
          "Structuration de la fonction recrutement : outils, process, formation et enablement pour une performance durable.",
          "/offre/outils-sourcing-enablement"
        ),
        faqSchema(faqs),
        breadcrumbSchema([
    ...
    <Breadcrumbs
      items={[
        { label: "Offres", to: "/offre/outils-sourcing-enablement" },
