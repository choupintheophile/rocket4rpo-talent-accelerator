    ...
    itemListElement: [
      {
        ...
        itemOffered: {
          ...
          description: "Un Talent Acquisition Specialist senior intégré dans vos équipes de 1 à 5 jours par semaine. Première shortlist en 48h, tous types de postes, à partir de 500€/jour.",
