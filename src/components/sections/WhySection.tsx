...
const reasons = [
  ...
  { icon: Crosshair, title: "Expertise chasse & approche directe", text: "Nos TA Specialists maîtrisent le sourcing avancé, le cold outreach et l'identification de talents passifs." },
